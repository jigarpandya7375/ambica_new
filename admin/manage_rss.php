			...
			<div class="side-content fr">
               ...
               <div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Management Rss Feeds</h3>
						...
						<table id="tab1">
							...
							<thead>
								...
								<tr>
									...
									<th  style="width:300px;"><center>RSS Title</center></th>
									<th style="width:300px;"><center>RSS Link</center></th>
                            ...
                            <tr>
									...
									<td><center><?php echo $data['link'];?></center></td>       
                                    <td><center><?php echo shorter($data['description'],80);?></center></td>  
                                      <td><center>
                                    <?php
									if($data['status']=='Active')
									{
									 echo "<center>
                                    <div class='round' style='background-color:#060; width:40%; height:17px;'><font color='#FFFFFF'>".$data['status']."</font></div></center>";
									}
									else
									{
										  echo "<center>
                                    <div class='round' style='background-color:#FF0000; width:50%; height:17px;'><font color='#FFFFFF'>".$data['status']."</font></div></center>";
									}?>
                                    
									<td><center>
					<a href="add_rss.php?id=<?php echo $data['id']; ?>" class="table-actions-button ic-table-edit" title="Edit"></a>
                                        </center>
									</td>
								</tr>
                        ...
                        <center>                       
                        <a href="add_rss.php" class="button round blue image-right ic-add text-upper">Add New RSS Feed</a>
                        <a href="javascript:void(0);" class="button round blue image-right ic-favorite text-upper" onClick="set_action('checkalltabs[]','Active', 'Are you sure, you want to Active selected records?','rss','id','<?php echo $page_name[2];?>');">Active</a>
                        <a href="javascript:void(0);" class="button round blue image-right ic-favorite text-upper" onClick="set_action('checkalltabs[]','Inactive', 'Are you sure, you want to Inactive selected records?','rss','id','<?php echo $page_name[2];?>');">Inactive</a>	
                        <a href="javascript:void(0);" class="button round blue image-right ic-delete text-upper" onClick="set_action('checkalltabs[]','Delete', 'Are you sure, you want to delete selected records?','rss','id','<?php echo $page_name[2];?>');">Delete</a>
                       </center>
