			...
			<div class="side-content fr">
				...
				<div class="content-module">
							  ...
							  foreach ($mail as $to) 
								{
								 ...
								 $email_message="<table width='698' cellspacing='0' cellpadding='0' border='0' align='center' style='border:1px solid #ccc;padding-top:10px'>
									...
									<a target='_blank' href='http://www.sohamtech.net'><img width='250' height='70' border='0' style='display:block;padding-left:10px' src='http://sohamtech.net/admin/images/logo.png' alt='Sohamtech.net'></a></td>
									...
									<tr>
									<td>
									<a target='_blank' href='http://sohamtech.net'><img width='698' height='187' border='0' style='display:block' src='http://sohamtech.net/admin/images/header.jpg' alt='Sohamtech.net'/></a></td>
									</tr>
					...
					?>
                        ...
                        <div class="confirmation-box round">Please Check Your Spam Folder....To Check E-Mail.... If E-Mail Not Display In " INBOX "</div>
