        ...
        <?php include('include/side_menu.php');?>
			...
			<div class="side-content fr">
               ...
               <div class="content-module">
					...
					{
					?>
                    <div class="confirmation-box round">Your FAQ Request Completed Successfully....</div>
						...
						<table id="tab1">
							...
							<thead>
								...
								<tr>
									...
									<th  style="width:300px;"><center>FAQ Question</center></th>
									<th style="width:300px;"><center>FAQ Answer</center></th>
                                  
                                    <th style="width:300px;"><center>Status</center></th>
						    ...
						    $sql="select * from ".$SUFFIX."faq";
							if($_GET['search'])
							{							
							 $sql.=" where faq_question like'".$_GET['search']."%'";
						    ...
						    ?>
                            <tr>
									<td><input type="checkbox" name="checkalltabs[]" id="checkalltabs[]" value="<?php echo $data['faq_id'];?>"></td>							
								    <td><center><?php echo $data['faq_question'];?></center></td>
									<td><center><?php if($data['faq_answer']!=''){echo shorter($data['faq_answer'],150);}else{echo "N/A";}?></center></td>   
                                      <td><center>
                                    <?php
									...
									<td><center>
					<a href="faq.php?id=<?php echo $data['faq_id']; ?>" class="table-actions-button ic-table-edit" title="Edit"></a>
                                        </center>
									</td>
								</tr>
                        ...
                        <center>                       
                        <a href="faq.php" class="button round blue image-right ic-add text-upper">Add New FAQ</a>
                        <a href="javascript:void(0);" class="button round blue image-right ic-favorite text-upper" onClick="set_action('checkalltabs[]','Active', 'Are you sure, you want to Active selected records?','faq','faq_id','<?php echo $page_name[3];?>');">Active</a>
                        <a href="javascript:void(0);" class="button round blue image-right ic-favorite text-upper" onClick="set_action('checkalltabs[]','Inactive', 'Are you sure, you want to Inactive selected records?','faq','faq_id','<?php echo $page_name[3];?>');">Inactive</a>	
                        <a href="javascript:void(0);" class="button round blue image-right ic-delete text-upper" onClick="set_action('checkalltabs[]','Delete', 'Are you sure, you want to delete selected records?','faq','faq_id','<?php echo $page_name[3];?>');">Delete</a>
                       </center>
