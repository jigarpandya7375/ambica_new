...

{
								...
								$sql="select * from ".$SUFFIX."category where cat_id='".$_REQUEST['id']."'";
											...
											//echo "innder";exit;
											 ...
											 if($upload_status)

												{
													...
													$new_name = $path."am_cat_".time().".jpg";

													$db_name = "am_cat_".time().".jpg";
													...
													if(watermark_image($path.$_FILES['image']['name'], $new_name,$height,$width))
													 ...
													 $sql="insert into ".$SUFFIX."category values(null,'".$_POST['title']."','".$_POST['desc']."','".$db_name."','".date("Y-m-d H:i:s")."','".$_POST['status']."')";
...

													 {
														 ...
														 header('location:manage_category.php?res='.base64_encode('success'));
...
{		
...

	{
...

				  {
									...
									$filename = $file_path.'category_images/'.$_REQUEST['prv_image'];
...

				{
					...
					//mkdir("../img/category_image/".$_POST['title'], 0777, true);
					 ...
					 $sql="update ".$SUFFIX."category set cat_name='".$_POST['title']."',cat_desc='".$_POST['desc']."',cat_image='".$db_image_name."',status='".$_POST['status']."' where cat_id='".$_REQUEST['id']."'";
							...
							<form  method="post" name="form_category" id="form_category" enctype="multipart/form-data">
								...
								<fieldset>
									...
									<p>
										...
										<input type="text" id="another-simple-input" name="title" class="round default-width-input validate[required] text-input" value="<?php echo $data['cat_name'];?>" <?php //if($_REQUEST['id']){echo "readonly='readonly'";};?>/>
                                    ...
                                    <p>
										...
										<label for="another-simple-input">Category Description</label>

										<textarea  name="desc"  class="round default-width-input validate[required] text-input"><?php echo $data['cat_desc'];?></textarea>
                                     ...
                                     <p>
										...
										<label for="another-simple-input">Choose Category Image</label>
                                        ...
                                        <em> <a  href="<?php echo $SITE_PATH;?>img/category_image/<?php echo $data['cat_image']?>" class="fancybox-effects-c" title="<?php echo shorter($data['fullname'],80);?>"><img src="<?php echo $SITE_PATH;?>category_images/<?php echo $data['cat_image'];?>" height="100" width="150" style="border-radius: 15px;"/></a></center>
									...
									?>
                                     ...
                                     <input type="submit" name="edit_category" id="edit_category" class="button round blue image-right ic-add text-upper" value="Edit category Detail"/>

                                     <input type="hidden" name="action" id="action" value="Edit"/>

                                    <input type="hidden" name="id" id="id" value="<?php echo $_GET['id']?>"/> 

                                    <input type="hidden" name="prv_image" id="prv_image" value="<?php echo $data['cat_image'];?>"/>

                                 <input type="hidden" name="prv_dir_name" id="prv_dir_name" value="<?php echo $data['cat_name'];?>"/>
