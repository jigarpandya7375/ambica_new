...
<head>
...

	{
		...
		var r=confirm('Are u Sure...!!!\r\n You Want To Delete This Menu...!!!\r\n It Deleted All Menu Item from That Menu Category ........?')
...

		{
			...
			window.location.href='delete_category.php?id='+id+'&name='+name+'&image='+image+'&page_id='+page_id;
					...
					?>
						...
						<table id="tab1">
                            ...
                            <tr>
									 ...
									 <td><input type="checkbox" name="checkalltabs[]" id="checkalltabs[]" value="<?php echo $data['cat_id'];?>"></td>

									<td><center>

                                      <a  href="<?php echo $SITE_PATH;?>category_images/<?php echo $data['cat_image']?>" class="fancybox-effects-c" title="<?php echo shorter($data['fullname'],80);?>"><img src="<?php echo $SITE_PATH;?>category_images/<?php echo $data['cat_image']?>" height="60" width="80" style="border-radius: 15px;"/></a></center></td>

								    <td><center><?php echo shorter($data['cat_name'],50);?></center></td>

                                    <td><center><?php echo format_date_time($data['cat_date']);?></center></td>
									...
									<td><center>
										...
										<a href="new_category.php?id=<?php echo $data['cat_id']; ?>&page_id=<?php echo $_REQUEST['page_id'];?>" class="table-actions-button ic-table-edit" title="Edit"></a> &nbsp;&nbsp;

                                        

                                     <a style="margin-left:15px;" href="javascript:void(0);" onClick="javascript:delete_cat('<?php echo $data['cat_id'];?>','<?php echo $data['cat_name'];?>','<?php echo $data['cat_image'];?>','<?php if($_REQUEST['page_id']){echo $_REQUEST['page_id'];}else{echo "1";};?>');" class="table-actions-button ic-table-delete" title="Delete"></a>
                        ...
                        <center>    
                         ...
                         <a href="new_category.php" class="button round blue image-right ic-add text-upper">Add New Category</a>                   

                        <a href="javascript:void(0);" class="button round blue image-right ic-favorite text-upper" onClick="set_action('<?php echo $_GET['page_id'];?>','checkalltabs[]','Active', 'Are you sure, you want to change The Status of selected records...?','category','cat_id','<?php echo $page_name[2];?>');">Active</a>

                        

                        

                        <a href="javascript:void(0);" class="button round blue image-right ic-favorite text-upper" onClick="set_action('<?php echo $_GET['page_id'];?>','checkalltabs[]','Inactive', 'Are you sure, you want to change the Status of selected records..?','category','cat_id','<?php echo $page_name[2];?>');">Inactive</a>	
