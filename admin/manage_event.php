...
<head>
	<meta charset="utf-8">
	<title>Soham Tech - Event Manage </title>
	...
	function delete_cat(id,name)
	{
		...
		var r=confirm('Are u Sure...!!!\r\n You Want To Delete Event Details.......?')
		if(r==true)		
		{
			
			window.location.href='delete_event.php?id='+id+'&name='+name;
	...
	function cat_status(id,status)
	{
		...
		var r=confirm('Are u Sure...!!!\r\n You Want To Change Event Status ...!!')
		if(r==true)		
		{
			
			window.location.href='change_event_status.php?id='+id+'&status='+status;
			...
			<div class="side-content fr">
               ...
               <div class="content-module">
					...
					?>
						...
						<table>
							...
							<thead>
								...
								<tr>
									...
									<th style="width:300px;"><center>Event Description</center></th>
                                    <th  style="width:150px;"><center>Event Venue</center></th>                                   
                                    <th  style="width:150px;"><center>Event Date</center></th>
						    ...
						    $sql="select * from ".$SUFFIX."event";
							if($_GET['search'])
							{							
							 $sql.=" where ev_name like'".$_GET['search']."%'";
                            ...
                            <tr>
									...
									<td><center><?php echo shorter($data['ev_desc'],50);?></center></td>
                                    <td><center><?php echo $data['ev_venue'];?></center></td>                                    
                                    <td><center><?php echo $data['ev_date'];?></center></td>
                                    <td><center><a href="javascript:void(0);"  onClick="javascript:cat_status('<?php echo $data['ev_id']?>','<?php echo $data['ev_status']?>');">
                                    <?php
									if($data['ev_status']=='ACTIVE')
									{
									echo "<font color='green'>".$data['ev_status']."</font>";
									}
									else
									{
										echo "<font color='red'>".$data['ev_status']."</font>";
									}?>
									...
									<td><center>
										<a href="edit_event_detail.php?id=<?php echo $data['ev_id']; ?>" class="table-actions-button ic-table-edit" title="Edit"></a>
                                        
										<a style="margin-left:15px;" href="javascript:void(0);" onClick="javascript:delete_cat('<?php echo $data['ev_id'];?>','<?php echo $data['ev_name'];?>');" class="table-actions-button ic-table-delete" title="Delete"></a></center>
									</td>
								</tr>
                        ...
                        <ul><li><a href="add_event_detail.php" class="button round blue image-right ic-add text-upper">Add New Event Details</a></li></ul>
